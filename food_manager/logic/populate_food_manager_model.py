...
from food_manager.models import FoodQuality, FoodItemDLC, FoodItemSource, Recipe, RecipeIngredient
...
def populate_dlc_model(data):
    if data['dlc_name'] is None or data['dlc_wiki_url'] is None or data['dlc_image_url'] is None:
        name = 'Base Game'
